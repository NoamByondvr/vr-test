...
then
   echo "File $DST_ZIP exist."
    ...
    echo "File $DST_ZIP does not exist" >&2
	...
	echo "y" | $ANDROID_DIR/tools/android update sdk --no-ui --all --filter tool,platform-tool,android-23,android-24,android-25,build-tools-25.0.1,build-tools-25.0.2
fi
